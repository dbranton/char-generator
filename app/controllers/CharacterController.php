...
class CharacterController extends \BaseController {
    ...
    public function store() {
        ...
        $data = array(
            ...
            'strength' => $character['ability']['str']['score'],
            'dexterity' => $character['ability']['dex']['score'],
            'constitution' => $character['ability']['con']['score'],
            'intelligence' => $character['ability']['int']['score'],
            'wisdom' => $character['ability']['wis']['score'],
            'charisma' => $character['ability']['cha']['score'],
